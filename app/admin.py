...
class AboutusAdmin(admin.ModelAdmin):
    list_display = ('id', 'words', 'icon1_title', 'icon2_title', 'icon3_title', 'icon4_title')
...
class ServicesAdmin(admin.ModelAdmin):
    list_display = ('id', 'header1', 'header2', 'icon1_title', 'icon2_title', 'icon3_title')
...
class WhyusAdmin(admin.ModelAdmin):
    list_display = ('id', 'header1', 'header2', 'icon1_title', 'icon2_title', 'icon3_title', 'icon4_title')
...
class TeamAdmin(admin.ModelAdmin):
    list_display = ('id', 'header1', 'header2', 'icon1_name', 'icon2_name', 'icon3_name', 'icon4_name')
...
class ClientsAdmin(admin.ModelAdmin):
    list_display = ('id', 'header1', 'header2')
...
class ConstructionAdmin(admin.ModelAdmin):
    list_display = ('id', 'header1', 'header2', 'subservices')
    search_fields = ('header1', 'header2')

admin.site.register(Construction, ConstructionAdmin)


class RemodelingAdmin(admin.ModelAdmin):
    list_display = ('id', 'header1', 'header2', 'subservices')
    search_fields = ('header1', 'header2')

admin.site.register(Remodeling, RemodelingAdmin)
